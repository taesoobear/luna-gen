...
public:
	...
	void removeBone(Bone& target);//!< assumes that only m_cPostureIP uses this skeleton.
	...
	enum { HIPS, LEFTHIP , LEFTKNEE, LEFTANKLE, LEFTTOES,RIGHTHIP, RIGHTKNEE, RIGHTANKLE, RIGHTTOES, CHEST, CHEST2, LEFTCOLLAR, LEFTSHOULDER, LEFTELBOW, LEFTWRIST, RIGHTCOLLAR, RIGHTSHOULDER, RIGHTELBOW, RIGHTWRIST, NECK, HEAD, NUM_JOINT_VOCA};
